...
<section class="woocommerce-customer-details">
	...
	<h2 class="woocommerce-column__title"><?php _e( 'Billing address', 'softpoint' ); ?></h2>

	<address>
		<?php echo wp_kses_post( $order->get_formatted_billing_address( __( 'N/A', 'softpoint' ) ) ); ?>
	...
	<?php if ( $show_shipping ) : ?>
		...
		<div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col-md-6">
			<h2 class="woocommerce-column__title"><?php _e( 'Shipping address', 'softpoint' ); ?></h2>
			<address>
				<?php echo wp_kses_post( $order->get_formatted_shipping_address( __( 'N/A', 'softpoint' ) ) ); ?>
			</address>
		</div><!-- /.col-2 -->
